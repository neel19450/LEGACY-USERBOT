...
async def amireallyalive(alive):
    ...
    f"**⚡️ 𝗥𝗘𝗣𝗢⚡️➪ [LEGACY](https://github.com/neel19450/LEGACY-USERBOT)** \n"
    f"**⚡️𝗖𝗛𝗔𝗡𝗡𝗘𝗟⚡️➪ [𝗝𝗢𝗜𝗡](https://t.me/LEGACY_USERBOT)** \n"
    f"**⚡️𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡️➪ [𝗝𝗢𝗜𝗡](https://t.me/LEGACY_USERBOT_SUPPORT_CHAT)**")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
